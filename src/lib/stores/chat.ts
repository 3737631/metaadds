...
const GLOSSARY_ES_EN: Record<string, string> = {
  ...
  "ver menos": "See less",
  "leer más": "Read more",
  "nuestras redes": "Our social media",
  ...
  "precio rebajado": "Sale price",
  "oferta": "Sale",
  "en oferta": "On sale",
  "nuevo": "New",
  "sin stock": "Out of stock",
  "últimas unidades": "Last units",
  "número de artículos": "Item count",
  "artículos": "Items",
  "productos": "Products",
  ...
  "compartir en correo": "Share by email",
  "imprimir": "Print",
  "descargar": "Download",
  "descargas": "Downloads",
  ...
  "envío estimado": "Estimated shipping",
  "entrega estimada": "Estimated delivery",
  "fecha de entrega": "Delivery date",
  "devolver": "Return",
  "solicitar devolución": "Request a return",
  "reembolso": "Refund",
  "garantía": "Warranty",
  "garantía de 30 días": "30-day warranty",
  "opiniones de clientes": "Customer reviews",
  "preguntas sobre este producto": "Questions about this product",
  "responder": "Reply",
  "cancelar": "Cancel",
  ...
  "buscador": "Search",
  "buscar en la tienda": "Search the store",
  ...
  "no quedan artículos": "No items left",
  "todo agotado": "Sold out",
  "solo quedan": "Only",
  "quedan": "Left",
